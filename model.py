...
class DCGAN(object):
    ...
    def train(self, config):
        ...
        for epoch in range(config.epoch):
            ...
            train_c1 = self.train_c1[order]
            train_c2 = self.train_c2[order]
            train_c3 = self.train_c3[order]
    ...
    def generator(self, z, y=None):
        with tf.variable_scope("generator") as scope:
            ...
            z = concat([z, y], 1)  # add condition y to z, z is 64*(100+10)
